    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-card">
                <img class="sidebar-card-illustration mb-2" src="<?php echo e(URL::asset('images/undraw_rocket.svg')); ?>" alt="">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo e(URL::asset('images/undraw_profile_1.svg')); ?>"
                                            alt="">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo e(URL::asset('images/undraw_profile_2.svg')); ?>"
                                            alt="">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo e(URL::asset('images/undraw_profile_3.svg')); ?>"
                                            alt="">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?php echo e(URL::asset('images/undraw_profile.svg')); ?>">
                            </a>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<?php echo e(URL::asset('images/undraw_posting_photo.svg')); ?>" alt="">
                                    </div>
...
</html><?php /**PATH /var/www/html/myshop/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>